...
int main(int argc, char **argv)
{
    ...
    //connection connection(connection_type::usbconnection, sensorMessage, inputDevice);
    ...
    ros::Publisher accel_pub =    n.advertise<ximu3_ros_driver::Accel>(topicName.append("accel"), 1000);
    topicName = "/sensor" + std::to_string(inputDevice) + "/";
    ros::Publisher gyro_pub =     n.advertise<ximu3_ros_driver::Gyro>(topicName.append("gyro"), 1000);
    topicName = "/sensor" + std::to_string(inputDevice) + "/";
    ros::Publisher mag_pub =      n.advertise<ximu3_ros_driver::Mag>(topicName.append("mag"), 1000);
    topicName = "/sensor" + std::to_string(inputDevice) + "/";
    ros::Publisher quat_pub =     n.advertise<ximu3_ros_driver::Quaternion>(topicName.append("quat"), 1000);
    topicName = "/sensor" + std::to_string(inputDevice) + "/";
    ros::Publisher rot_pub =      n.advertise<ximu3_ros_driver::RotMatrix>(topicName.append("rot"), 1000);
    topicName = "/sensor" + std::to_string(inputDevice) + "/";
    ros::Publisher euler_pub =    n.advertise<ximu3_ros_driver::Euler>(topicName.append("euler"), 1000);
    topicName = "/sensor" + std::to_string(inputDevice) + "/";
    ros::Publisher linaccel_pub = n.advertise<ximu3_ros_driver::LinearAccel>(topicName.append("linaccel"), 1000);  
